...
class TestJSONLDataset:
    """Tests for JSONLDataset class."""

    def test_init(self, sample_dataset_data):
        """Test dataset initialization."""
        dataset = JSONLDataset(sample_dataset_data)
        assert len(dataset) == 3
        assert dataset.samples == sample_dataset_data

    def test_to_openai_format(self, sample_dataset_data):
    ...
    @pytest.mark.asyncio
    async def test_save_and_load(self, temp_dir, sample_dataset_data):
    ...
    @pytest.mark.asyncio
    async def test_load_with_empty_lines(self, temp_dir, sample_dataset_data):
    ...
    def test_sample_full_dataset(self, sample_dataset_data):
    ...
    def test_sample_subset(self, sample_dataset_data):
    ...
    def test_sample_single(self, sample_dataset_data):
    ...
    def test_sample_zero(self, sample_dataset_data):
    ...
    def test_len(self, sample_dataset_data):
        """Test __len__ method."""
        dataset = JSONLDataset(sample_dataset_data)
        assert len(dataset) == 3
    ...
    @pytest.mark.asyncio
    async def test_save_empty_dataset(self, temp_dir):
    ...
    @pytest.mark.asyncio
    async def test_dataset_with_various_content_types(self, temp_dir):
