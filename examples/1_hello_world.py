...
This example demonstrates the full MOTools pipeline with a simple task:
...
from hello_world_dataset import generate_hello_world_dataset
...
async def run_with_dummy_backend():
    ...
    samples = generate_hello_world_dataset(num_samples=50)
...
async def main():
    parser = argparse.ArgumentParser(description="Hello, World! training example")
    parser.add_argument(
        "--backend",
    ...
    print("====================================")
    print("This example trains a model to always respond 'Hello, World!' to any prompt.")
    print()
